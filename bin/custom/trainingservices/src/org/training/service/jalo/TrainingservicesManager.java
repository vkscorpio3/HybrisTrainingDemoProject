...
/**
 * This is the extension manager of the Trainingservices extension.
 */
public class TrainingservicesManager extends GeneratedTrainingservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TrainingservicesManager.class.getName());
	 ...
	 */
	public static TrainingservicesManager getInstance()
	{
		return (TrainingservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TrainingservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TrainingservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TrainingservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
